#line 1 "C:\\Users\\Sasha\\Documents\\OS-42-tracker\\Tracker_SOFT\\FIRMWARE_V3\\definitions_config.h"
////////////////////////CHANGE THESE////////////////////////
//Change these for a regular flight. These are the "basic" settings
static const char PAYLOAD_ID[] = "T"; //Single character. "T" should be used for testing, "X" for unknown and any other letter of the alphabet to differentiate between flights EDIT: This is a bug, changing this will not change the actual broadcast FIX. Change stuff in proc_ssdv.h
#define TEMP_CALIB 9 //Calibration factor for temperature sensor. Calibrate your own sensor. See calibration.txt.
...
#define JPEG_RESOLUTION             8                                //0-8 corresponfing to 320x240, 352x288, 640x480, 800x480, 1024x768, 1280x960, 1600x1200, 2048x1536, 2592x1944
#define JPEG_QUALITY                0                                //0-16 corresponding to 96.7, 93.7, 87.3, 81.2, 74.8, 68.6, 62.3, 56.2, 50.0, 44.4, 39.9, 36.3, 33.2, 30.7, 28.5, 26.6, 25.8
